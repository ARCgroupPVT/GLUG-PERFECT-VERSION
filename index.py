...
SKIP_WEEKS_FROM_FRONT = 13
SKIP_DAYS_FROM_ABOVE = 1
COMMIT_PER_DAY_FOR_HIGHLIGHTED = 30
COMMIT_PER_DAY_FOR_SHADOW = 5

OWNER = "ARCgroupPVT"
EMAIL = "219491010+ARCgroupPVT@users.noreply.github.com"
REPO_NAME = "GLUG-PERFECT-VERSION"
...
def main():
    ...
    create_local_repo()
    create_remote_repo(delete_existing=False)
